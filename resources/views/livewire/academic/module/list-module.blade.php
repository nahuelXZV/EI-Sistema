        ...
        <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg overflow-hidden">
            <div class="relative overflow-hidden bg-white  dark:bg-gray-800 sm:rounded-lg">
                <div class="flex-row items-center justify-between p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4">
                    <div>
                        <h5 class="mr-3 text-lg font-bold dark:text-white uppercase">Modulos</h5>
                    </div>
                        ...
                        @foreach ($modules as $module)
                            <tr
                                ...
                                <td
                                    ...
                                    <x-shared.button icon="show" route="module.show" color="green" type="a"
                                        :hover="600" :params="$module->id" tonality="400" />
                                    <x-shared.button icon="edit" route="module.edit" color="blue" type="a"
                                        :params="$module->id" />
                                    <x-shared.button icon="delete" color="red" type="button" :params="$module->id" />
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
