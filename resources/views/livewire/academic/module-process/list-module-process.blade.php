        ...
        <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg overflow-hidden">
            <div class="relative overflow-hidden bg-white  dark:bg-gray-800 sm:rounded-lg">
                <div class="flex-row items-center justify-between p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4">
                    <div>
                        <h5 class="mr-3 text-lg font-bold dark:text-white uppercase">Procesos</h5>
                    </div>
                    <a href="{{ route('process.new') }}"
                        ...
                        @foreach ($processes as $process)
                            <tr
                                ...
                                <td
                                    ...
                                    <x-shared.button color="green" tonality="400" type='button' action='level_up'
                                        icon="arrow-up" :params="$process->id" />
                                    <x-shared.button color="green" tonality="400" type='button' action='level_down'
