        ...
        <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg overflow-hidden">
            <div class="relative overflow-hidden bg-white  dark:bg-gray-800 sm:rounded-lg">
                <div class="flex-row items-center justify-between p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4">
                    <div>
                        <h5 class="mr-3 text-lg font-bold dark:text-white uppercase">Carreras</h5>
                    </div>
                    <a href="{{ route('career.new') }}"
                        ...
                        @foreach ($careers as $career)
                            <tr
                                ...
                                <td
                                    ...
                                    <x-shared.button icon="edit" route="career.edit" color="blue" type="a"
                                        :params="$career->id" />
                                    <x-shared.button icon="delete" color="red" type="button" :params="$career->id"
                                        action="delete" />
                                    </button>
                                </td>
                            </tr>
