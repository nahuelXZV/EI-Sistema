...
class ComunicacionInterna extends Component
{
    public $breadcrumbs;
    public $letter;
    ...
    public $validate = [
        'parameters.numero_oficio' => 'required',
        'dateLetter' => 'required|date',
        'administrativeCode' => 'required'
    ];

    public $message = [
        'parameters.numero_oficio.required' => 'El numero de oficio es requerida',
    ...
    public function mount($letter)
    {
        ...
        $this->breadcrumbs = [
            ...
            ['title' => LettersTemplate::COMUNICACIONINTERNA, "url" => "letter.termino-referencia", "id" => $this->letter->id] // carta
        ];
    ...
    {
        return view('livewire.academic.contract.letters.comunicacion-interna');
    }
}
