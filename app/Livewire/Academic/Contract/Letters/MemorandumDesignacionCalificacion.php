...
class MemorandumDesignacionCalificacion extends Component
{
    public $breadcrumbs;
    public $letter;
    ...
    public function mount($letter)
    {
        ...
        $this->breadcrumbs = [
            ...
            ['title' => LettersTemplate::MEMORANDUMDESIGNACIONCALIFICACION, "url" => "letter.termino-referencia", "id" => $this->letter->id] // carta
        ];
    ...
    {
        return view('livewire.academic.contract.letters.memorandum-designacion-calificacion');
    }
}
